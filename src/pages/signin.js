    ...
    <>
      ...
      >
        ...
        <form
          ...
          className="w-full lg:w-[33%] flex justify-center  items-center lg:px-0 px-2 "
        >
          <div className="flex flex-col border h-[350px] bg-[#0D1117]  border-[#30363D] rounded-[10px] w-[380px] lg:w-[80%] relative">
            <div className="text-red-500  absolute bottom-[-30px] right-2">
              {error && error}
            </div>
            ...
            <div className="w-full flex px-5 mt-2 items-center lg:hidden">
              <div className="relative " onClick={ClickFunc}>
                ...
                <div
                  className={`block w-8 h-5 rounded-full duration-[350ms] border border-xs ${
                    form.type == 1
                      ? "bg-[#4f688d] border-black"
                      : "bg[#3b82f6] border-white  "
                  }`}
                ></div>
                <div
                  className={`dot absolute  top-1 bg-white w-3  h-3  outline-black rounded-full duration-300 transition-transform ${
                    form.type == 1 ? "translate-x-4" : "left-1"
                  }`}
                ></div>
              </div>
              <label className={`text-white mx-5`} for={"switch"}>

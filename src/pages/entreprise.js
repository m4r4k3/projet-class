...
export default function Entreprise() {
  ...
  return (
    <div className="bg-[url('../image/pattern.png')] w-full flex flex-col sm:flex-row sm:justify-around pt-[70px] min-h-screen">
      <div className="sm:w-[40%] w-[90%] flex flex-col items-end p-3">
        <div className=" flex  justify-between items-center  flex-col  mx-auto sm:bg-[#0D1117] sm:border border-[#30363D] sticky top-[80px] rounded-[5px] w-[35vw] py-[3%]">
      ...
      <div className="sm:w-[55%] w-[90%] mx-auto sm:mx-0 bg-[#0D1117] border border-[#30363D] rounded h-[350px]">

  ...
  return (
    <div className="bg-[url('../image/pattern.png')] w-full flex flex-col sm:flex-row sm:justify-around pt-[70px] min-h-screen">
      <div className="sm:w-[40%] w-full w-[90%] flex flex-col items-end sm:px-3 ">
        <div className=" flex  justify-between items-center  flex-col  mx-auto  sm:bg-[#0D1117] sm:h-[350px] sm:border border-[#30363D] sticky top-[70px] rounded-[5px] w-[35vw] py-[3%]">
          ...
          <div className="flex my-5 w-full flex justify-center">
            <span className="button bg-black border border-[#30363D]">
              <i class={`fa-solid fa-location-dot text-white`}></i>
            </span>
            <div className="text-[15px] text-white ">{data.location}</div>
          </div>

...
export default function FullScreenOffer({setOffer  ,offre}){
   const [showList , setList]=useState(false)
   const {characteristic ,  salary ,
   name ,
   domain ,
   city ,
   description,
   ...
   post,
    ...
    return( <div
          ...
          style={{ zIndex: 10 }}
        >
          <div className="w-[800px] h-[300px] rounded bg-white py-[3%] px-[5%] relative" onClick={e=>{setList(false);e.stopPropagation()}}>

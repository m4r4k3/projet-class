...
export default function OffresCard({
  ...
  return (
    ...
    >
            { !isOffer && <div className="absolute top-1 left-[-35px] flex-text-[#888888] text-xl z-[1]">
          <button onClick={deleteOffre} className="buttons bg-red-500 w-[30px]  text-white h-[30px] flex justify-center items-center mb-1 rounded-full"> <i className="fa-solid fa-trash"></i></button>
